        ...
        <div className="relative">
          ...
          <div className="relative h-48 sm:h-64 md:h-80 lg:h-96 overflow-hidden rounded-t-3xl">
            ...
            <Button
              ...
              size="sm"
              onClick={onClose}
              className="absolute top-3 right-3 sm:top-4 sm:right-4 md:top-6 md:right-6 bg-black/30 backdrop-blur-sm hover:bg-black/50 text-white border-0 h-8 w-8 sm:h-10 sm:w-10 p-0 rounded-full"
            >
            ...
            <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 md:bottom-6 md:left-6 md:right-6">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2 sm:mb-3 md:mb-4">
                ...
                {article.sentiment && (
                  <Badge variant="outline" className={`sentiment-${article.sentiment} border-white/30 text-xs px-2 py-1 rounded-full`}>
                    {article.sentiment}
                  </Badge>
                )}
          ...
          <div className="p-4 sm:p-6 md:p-8 lg:p-12">
            ...
            {/* AI Summary Section */}
            {article.summary && (
              <div className="bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/20 rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-6 sm:pt-8 border-t border-border/50">
              <Button
                ...
                className="w-full sm:w-auto bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 rounded-xl"
              >
                {isBookmarked ? (
                  <>
